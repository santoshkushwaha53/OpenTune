...
Primary navigation: **Home**, **Discover**, **Library**, with a mini-player above the bar. Home and Discover show availability badges (stream, download, offline, unavailable, attribution). Now playing streams from the provider URL, shows the queue, and opens a license sheet.
...
Default API base: `http://127.0.0.1:3000`. Android emulator: use `http://10.0.2.2:3000`. Production: set the API base to your TLS hostname ([docs/DEPLOY.md](../docs/DEPLOY.md)).
